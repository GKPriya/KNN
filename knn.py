...
def predict_preferred_language_by_city(k_values, cities):
    ...
    for k in k_values:
        ...
        for coordinates, language in cities:
            other_cities_list = []
            for other_cities in cities:
                if other_cities != (coordinates, language):
                    other_cities_list.append(other_cities)

            prediction = knn_classify(k, other_cities_list, coordinates)
